...
function exportToCSV() {
    ...
    const rows = filteredCompanies.map(c => {
        ...
        const _cd = new Date(c.created_at);
        const date = `${_cd.getFullYear()}.${String(_cd.getMonth()+1).padStart(2,'0')}.${String(_cd.getDate()).padStart(2,'0')}`;
...
function renderInbox() {
    ...
    items.forEach(item => {
        ...
        const dateStr = `${_id.getFullYear()}.${String(_id.getMonth()+1).padStart(2,'0')}.${String(_id.getDate()).padStart(2,'0')} ${String(_id.getHours()).padStart(2,'0')}:${String(_id.getMinutes()).padStart(2,'0')}`;
