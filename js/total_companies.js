...
function renderCompanies() {
    ...
    items.forEach(c => {
        ...
        $container.append(`<tr onclick="showCompanyDetail('${c.id}')" style="cursor: pointer;">
            ...
            <td class="date-td" style="padding: 20px 24px !important; border-right: 1px solid #f8fafc; text-align: left !important; font-size: 13px; color: #94a3b8; font-family: 'Outfit', sans-serif; line-height: 1.5;">${createdStr}<br>/${updatedStr}</td>
